    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('precio', djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0'), default_currency=b'EUR', max_digits=11)),
                ('thumbnail', models.ImageField(default='pic_folder/None/no-img.jpg', upload_to='pic_folder_productos/')),
